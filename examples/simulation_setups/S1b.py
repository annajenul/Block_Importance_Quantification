...
y_train = pd.read_csv("examples/data/simulation/y_train_S1b.csv").iloc[:,1:]
y_test = pd.read_csv("examples/data/simulation/y_test_S1b.csv").iloc[:,1:]
beta = pd.read_csv("examples/data/simulation/beta_S1b.csv").iloc[:,1:].values
...
pd.DataFrame(np.vstack(KO)).to_csv("results/simulation/results_S1b/MI_knock_out.csv", index=False)
pd.DataFrame(np.vstack(KI)).to_csv("results/simulation/results_S1b/MI_knock_in.csv", index=False)
pd.DataFrame(np.vstack(vargrad_max)).to_csv("results/simulation/results_S1b/vargrad_max.csv", index=False)
pd.DataFrame(np.vstack(vargrad_mean)).to_csv("results/simulation/results_S1b/vargrad_mean.csv", index=False)

pd.DataFrame(rmseiqr).to_csv("results/simulation/results_S1b/rmseiqr.csv", index=False)
pd.DataFrame(r2).to_csv("results/simulation/results_S1b/r2.csv", index=False)
