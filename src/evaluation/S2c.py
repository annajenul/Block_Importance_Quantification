...
y_train = pd.read_csv("data/simulation/y_train_S2c.csv").iloc[:,1:]
y_test = pd.read_csv("data/simulation/y_test_S2c.csv").iloc[:,1:]
beta = pd.read_csv("data/simulation/beta_S2c.csv").iloc[:,1:].values
...
pd.DataFrame(np.vstack(KO)).to_csv("raw_results/simulation/results_S2c/MI_knock_out.csv", index=False)
pd.DataFrame(np.vstack(KI)).to_csv("raw_results/simulation/results_S2c/MI_knock_in.csv", index=False)
pd.DataFrame(np.vstack(vargrad_max)).to_csv("raw_results/simulation/results_S2c/vargrad_max.csv", index=False)
pd.DataFrame(np.vstack(vargrad_mean)).to_csv("raw_results/simulation/results_S2c/vargrad_mean.csv", index=False)

pd.DataFrame(rmseiqr).to_csv("raw_results/simulation/results_S2c/rmseiqr.csv", index=False)
pd.DataFrame(r2).to_csv("raw_results/simulation/results_S2c/r2.csv", index=False)
