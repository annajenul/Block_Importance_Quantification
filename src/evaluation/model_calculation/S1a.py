...
pd.DataFrame(np.vstack(KO)).to_csv("raw_results/simulation/results_S1a/MI_knock_out.csv", index=False)
pd.DataFrame(np.vstack(KI)).to_csv("raw_results/simulation/results_S1a/MI_knock_in.csv", index=False)
pd.DataFrame(np.vstack(vargrad_max)).to_csv("raw_results/simulation/results_S1a/vargrad_max.csv", index=False)
pd.DataFrame(np.vstack(vargrad_mean)).to_csv("raw_results/simulation/results_S1a/vargrad_mean.csv", index=False)

pd.DataFrame(rmseiqr).to_csv("raw_results/simulation/results_S1a/rmseiqr.csv", index=False)
pd.DataFrame(r2).to_csv("raw_results/simulation/results_S1a/r2.csv", index=False)
